...
## 📋 Primary Reference
**ALWAYS refer to `TESTING_INSTRUCTIONS.md` before making test-related changes.**
...
- ✅ Follow the exact test file structure from TESTING_INSTRUCTIONS.md

## 📁 Key Files
- `TESTING_INSTRUCTIONS.md` - Complete testing guidelines (PRIMARY)
...
**Remember**: When in doubt, consult `TESTING_INSTRUCTIONS.md` for detailed examples and patterns.
