...
リンクは他のページやセクションへナビゲーションするためのコンポーネントです。
...
```bash
npx shadcn@latest add https://sparkle-design.vercel.app/r/link.json
```
...
- [Storybook](https://sparkle-design.vercel.app/storybook/index.html?path=/docs/components-link--docs)
