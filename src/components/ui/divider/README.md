...
```bash
npx shadcn@latest add https://sparkle-design.goodpatch.com/r/divider.json
```
...
- [ガイドライン](https://sparkle-design.goodpatch.com/guidelines/components/divider)
- [Storybook](https://sparkle-design.goodpatch.com/storybook/index.html?path=/docs/components-divider--docs)
