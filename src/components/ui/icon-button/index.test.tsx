...
describe('IconButton', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('forwards arbitrary props', () => {
      testContainer.render(<IconButton icon="plus" data-testid="custom-button" />)
  ...
  describe('Variant Styling', () => {
    describe('solid variant', () => {
      it('applies solid primary classes', () => {
        testContainer.render(<IconButton variant="solid" theme="primary" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies solid neutral classes', () => {
        testContainer.render(<IconButton variant="solid" theme="neutral" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies solid negative classes', () => {
        testContainer.render(<IconButton variant="solid" theme="negative" icon="plus" />)
        const button = testContainer.queryButton()
    ...
    describe('outline variant', () => {
      it('applies outline primary classes', () => {
        testContainer.render(<IconButton variant="outline" theme="primary" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies outline neutral classes', () => {
        testContainer.render(<IconButton variant="outline" theme="neutral" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies outline negative classes', () => {
        testContainer.render(<IconButton variant="outline" theme="negative" icon="plus" />)
        const button = testContainer.queryButton()
    ...
    describe('ghost variant', () => {
      it('applies ghost primary classes', () => {
        testContainer.render(<IconButton variant="ghost" theme="primary" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies ghost neutral classes', () => {
        testContainer.render(<IconButton variant="ghost" theme="neutral" icon="plus" />)
        const button = testContainer.queryButton()
      ...
      it('applies ghost negative classes', () => {
        testContainer.render(<IconButton variant="ghost" theme="negative" icon="plus" />)
        const button = testContainer.queryButton()
  ...
  describe('Loading State', () => {
    ...
    it('does not trigger click events when loading', () => {
      ...
      testContainer.render(<IconButton icon="plus" isLoading onClick={handleClick} />)
      const button = testContainer.queryButton()
  ...
  describe('Disabled State', () => {
    ...
    it('applies disabled styling for solid variant', () => {
      testContainer.render(<IconButton variant="solid" theme="primary" icon="plus" isDisabled />)
      const button = testContainer.queryButton()
    ...
    it('applies disabled styling for outline variant', () => {
      testContainer.render(<IconButton variant="outline" theme="primary" icon="plus" isDisabled />)
      const button = testContainer.queryButton()
    ...
    it('applies disabled styling for ghost variant', () => {
      testContainer.render(<IconButton variant="ghost" theme="primary" icon="plus" isDisabled />)
      const button = testContainer.queryButton()
    ...
    it('does not trigger click events when disabled', () => {
      const handleClick = vi.fn()
      testContainer.render(<IconButton icon="plus" isDisabled onClick={handleClick} />)
      const button = testContainer.queryButton()
  ...
  describe('User Interaction', () => {
    ...
    it('handles keyboard events', () => {
      ...
      testContainer.render(<IconButton icon="plus" onKeyDown={handleKeyDown} />)
      const button = testContainer.queryButton()
    ...
    it('handles focus and blur events', () => {
      ...
      testContainer.render(<IconButton icon="plus" onFocus={handleFocus} onBlur={handleBlur} />)
      const button = testContainer.queryButton()
