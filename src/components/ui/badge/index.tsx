 ...
 *
 * Modifications:
 * - role="status" をデフォルトで付与（WCAG 4.1.2 / 4.1.3 対応）
 * - en: Added default role="status" (WCAG 4.1.2 / 4.1.3 compliance)
 * - 代替テキスト欠如時の dev warn を追加（WCAG 1.1.1 対応）
 * - en: Added dev warning when alternative text is missing (WCAG 1.1.1 compliance)
 */
