  ...
  return (
    <ModalPortal data-slot="modal-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          sizeClass,
          "z-50 flex flex-col gap-0 w-full max-h-[calc(100vh-80px)] bg-surface-base-0 border-border-neutral-low py-4 rounded-modal data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] shadow-lg duration-200",
          className
        )}
