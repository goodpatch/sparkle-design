...
```bash
npx shadcn@latest add https://sparkle-design.vercel.app/r/tabs.json
```
...
- [Storybook](https://sparkle-design.vercel.app/storybook/index.html?path=/docs/components-tabs--docs)
