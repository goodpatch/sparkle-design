...
```bash
npx shadcn@latest add https://sparkle-design.vercel.app/r/tag.json
```
...
- [Storybook](https://sparkle-design.vercel.app/storybook/index.html?path=/docs/components-tag--docs)
